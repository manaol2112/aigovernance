...
export const PILLAR_EXPECTED_DOCUMENTATION: Record<string, PillarDocumentationItem[]> = {
  ...
  "supply-chain": [
    {
      ...
      description: "Requirements for procuring, integrating, and monitoring external AI services and ecosystem partners.",
  ...
  workforce: [
    {
      ...
      title: "AI Competency & Role Requirements Framework",
      description: "Defined competencies, role profiles, and proficiency expectations for AI actors.",
      typicalOwner: "Chief Learning Officer",
      priority: 1,
    },
    {
      id: "ai-training-curriculum",
      title: "AI Training & Certification Curriculum",
      description: "Role-based training programs covering responsible AI, technical, and governance skills.",
      typicalOwner: "Learning & Development",
      priority: 2,
    },
    {
      id: "interdisciplinary-team-charter",
      title: "Interdisciplinary AI Team Charter",
      description: "Charter defining cross-functional team composition, decision rights, and escalation.",
      typicalOwner: "AI Governance Office",
      priority: 3,
    },
    {
      id: "workforce-readiness-assessment",
      title: "Workforce Readiness Assessment",
      description: "Assessment of skill gaps, hiring plans, and human capital risks for AI operations.",
      typicalOwner: "HR / People Operations",
      priority: 4,
    },
    {
      id: "training-completion-records",
      title: "AI Training Completion & Proficiency Records",
      description: "Evidence of training completion, assessments, and ongoing refresh requirements.",
      typicalOwner: "Learning & Development",
      priority: 5,
    },
  ],
  "financial-resilience": [
    {
      id: "ai-business-continuity-plan",
      title: "AI Business Continuity & Resilience Plan",
      description: "Plans for maintaining critical AI services during disruption, failover, and recovery.",
      typicalOwner: "Business Continuity Manager",
      priority: 1,
    },
    {
      id: "ai-financial-impact-assessment",
      title: "AI Financial Impact Risk Assessment",
      description: "Assessment of material financial exposure from AI failures, outages, or misuse.",
      typicalOwner: "Enterprise Risk Management",
      priority: 2,
    },
    {
      id: "decommissioning-procedure",
      title: "AI System Decommissioning Procedure",
      description: "Documented phase-out, data retention, and stakeholder notification for retired AI systems.",
      typicalOwner: "AI System Owner",
      priority: 3,
    },
    {
      id: "operational-resilience-testing",
      title: "Operational Resilience Testing Records",
      description: "Results of resilience drills, failover tests, and recovery time validation for AI systems.",
      typicalOwner: "IT Operations",
      priority: 4,
    },
    {
      id: "sustainability-impact-report",
      title: "AI Sustainability & Environmental Impact Report",
      description: "Energy, carbon, and resource impact metrics for AI training and inference workloads.",
      typicalOwner: "Sustainability Lead",
      priority: 5,
    },
  ],
};
