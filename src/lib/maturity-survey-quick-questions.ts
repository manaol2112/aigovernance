...
export const PILLAR_CRITICAL_QUESTIONS: Record<string, PillarCriticalQuestion> = {
  ...
  "safety-reliability": {
    prompt: "How confident are you in the safety, accuracy, and reliability of AI outputs and behavior?",
    subtitle: "Addresses harm prevention, robustness testing, and resilience under edge cases.",
  },
  security: {
    prompt: "How prepared are you for AI-specific security threats — adversarial attacks, poisoning, and integrity?",
    subtitle: "Includes model and pipeline security, access controls, and monitoring for adversarial risk.",
  },
  transparency: {
  ...
  "supply-chain": {
    prompt: "How do you assess and govern third-party AI, vendors, and components in your supply chain?",
    subtitle: "Includes vendor due diligence, contractual controls, and dependency risk management.",
  },
  systemic: {
